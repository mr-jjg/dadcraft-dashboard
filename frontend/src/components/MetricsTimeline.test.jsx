...
describe('rendering', () => {
    ...
    test('renders nothing when window is too small', () => {
        const { container } = render(<MetricsTimeline windowSeconds={600} onChange={vi.fn()} />)
    ...
    test('fine steps excluded for large window', () => {
        render(<MetricsTimeline windowSeconds={ONE_HOUR * 24 * 90} onChange={vi.fn()} />)
