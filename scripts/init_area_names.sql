-- init_area_names.sql
-- Zone ID to name mapping sourced from AzerothCore AreaTable.dbc (3.3.5a)
-- Used by collect_character_cache.sh to decode zone integers to readable names.
-- Safe to re-run (INSERT IGNORE).

CREATE TABLE IF NOT EXISTS dadcraft_dashboard.area_names (
...
INSERT IGNORE INTO dadcraft_dashboard.area_names (id, name, map_id, area_id) VALUES
(1, 'Dun Morogh', 0, 0),
(2, 'Longshore', 0, 40),
(3, 'Badlands', 0, 0),
(4, 'Blasted Lands', 0, 0),
...
(4096, 'Clayton''s WoWEdit Land', 451, 4019),
